...
public class MainWindow extends JFrame {
	...
	mainWindowInstance = this;
        contentFile = new File("contentFile");
        signatureFile = new File(contentFile.getName() + ".sig.xml");
    ...
    protected void getSignContent() {
	    ...
	    // signContent must be saved on the temporary location
    ...
    protected void performSign() {
        ...
        try {
            ...
            // do the signature
            signer.sign(contentFile.getName(), contentFile.getName(), cargoField.getText(), descriptionArea.getText(), compromissoArea.getText());

            // add the timestamp
            XAdESSignatureTimeStamper ts = new XAdESSignatureTimeStamper();
            ts.signatureTimeStamp(signatureFile.getName(),tsaURL);

            if (signatureFile.exists()) {
                JOptionPane.showMessageDialog(this, "Assinatura realizada com sucesso", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
	...
	try {
	    ...
	    client.setParameter("file0", signatureFile);
	    client.setParameter("file1", contentFile);
	...
	jLabel7.setText("Descrição");
        ...
        jLabel2.setText("Identidade (teste):");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 383, Short.MAX_VALUE)
                    .addComponent(identityEmissionField, javax.swing.GroupLayout.DEFAULT_SIZE, 383, Short.MAX_VALUE)
                    .addComponent(identityField, javax.swing.GroupLayout.DEFAULT_SIZE, 383, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel9)
                    .addComponent(identityValidadeField, javax.swing.GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(cargoField, javax.swing.GroupLayout.PREFERRED_SIZE, 23, Short.MAX_VALUE)))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(2, 2, 2)
