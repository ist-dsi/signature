...
public enum SignatureDataFormat {
	 ...
	 *         the delimiters above {@link #BEGIN_XHTML_FILE}
	 *         {@link #BEGIN_XML_FILE} {@link #END_XHTML_FILE}
	 *         {@link #END_XML_FILE}
	 */
	...
	@Override
	public void validateSignature(SignatureData signatureDataInfoSource, Set<User> permittedUsers,
	...
	@Override
	public void validateSignature(SignatureData signatureDataSourceOfInfo, Set<User> permittedUsers,
		Set<User> excludedUsers, boolean mustIncludeAllPermittedUsers) throws SignatureDataException {
